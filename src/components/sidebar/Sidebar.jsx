...
function Sidebar() {
    ...
    const [users, setUsers] = useState([
        ...
        { socketId: 1, username: 'Piyush Aryan', isOnline: true },
        { socketId: 2, username: 'Ayush Aryan', isOnline: false },
        { socketId: 3, username: 'Samridhi Aryan', isOnline: true },
        { socketId: 4, username: 'Pragya Aryan', isOnline: false },
        { socketId: 5, username: 'Satakshi Aryan', isOnline: true },
        { socketId: 6, username: 'Shristi Aryan', isOnline: false },
